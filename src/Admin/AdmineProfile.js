...
import {APIData} from '../Authentication/APIData';
    ...
    async componentDidMount(){
        const url = APIData.api+"admins/" + sessiondetails.user;
    ...
    this.setState({admin_name_error , admin_email_error , admin_phone_number_error});
    return false;
    }
    return true;
    }
    ...
    toast(response);
    const url = new URL('portal.smarterlearning.in');
    ...
    if(this.state.admin_phone_number.length != 10 && this.state.admin_phone_number.length != 12){
    ...
    <div className="bringitcenter"><p 
    className="ptag"
    type="text"
    name="admin_id"

    >ADMIN ID :<strong className="ptag">{this.state.admin_id}</strong></p></div>
    <div className="bringitcenter">
    <p className="ptag">
    Permissions :
    <strong 
...
{this.state.admin_permissions}
    ...
    />
    {this.state.admin_name_error ? (<div style={{color:'red' }}>
    ...
    onChange={this.changeHandler}
    />
    {this.state.admin_email_error ? (<div style={{color:'red' }}>
    ...
    {this.state.admin_phone_number_error ? (<div style={{color:'red' }}>
